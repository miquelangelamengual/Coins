...
public class CustomHeads {
  ...
  static {
    ...
    int[] version = Arrays
      .stream(versionString.substring(0, versionString.indexOf('-')).split("\\."))
   ...
   */
  public static ItemStack create(String displayName, List<String> lore, String texture) {
    ...
    ItemStack craftItemStack = CraftItemStack.asBukkitCopy(nmsItem);
